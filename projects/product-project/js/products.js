...
function createProduct(products) {
    _.each(products, function(product, i){
        ...
        var $desc = $('#desc' + i ).prepend('<li style="list-style: none" class = flex-item id = description' + i + '">' + product.desc);
        $desc.appendTo('#desc li' + i);

        var $color = $('#desc' + i ).append('<li class = flex-item id = description' + i + '">' + "<b>Color: </b>" + product.color);
        $color.appendTo('#description li' + i);
        
        var $price = $('#desc' + i ).append('<li class = flex-item id = description' + i + '">' + "<b>Price:</b> $" + product.price);
        $price.appendTo('#description li' + i);
